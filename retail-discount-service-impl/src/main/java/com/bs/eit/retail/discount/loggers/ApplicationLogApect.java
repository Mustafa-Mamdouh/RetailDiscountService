package com.bs.eit.retail.discount.loggers;
...
public class ApplicationLogApect {
	...
	@Around("execution(* com.bs.eit.retail.discount.*..*(..))")
	...
	@AfterThrowing(pointcut = "execution(* com.bs.eit.retail.discount.*..*(..))", throwing = "ex")
